      ...
      >
        ...
        <div class="divide-y divide-[var(--app-border)]">
          <NuxtLink
            ...
            :key="p.id"
            :to="isLevelUnlocked(group.level) ? `/dsa/problems/${p.slug}` : '#'"
...
const statCards = computed(() => [
  ...
  { label: 'Dashboard', value: '→', color: 'text-emerald-500', bgClass: 'bg-emerald-500/15', icon: LayoutDashboard, link: '/dsa/dashboard' },
])
