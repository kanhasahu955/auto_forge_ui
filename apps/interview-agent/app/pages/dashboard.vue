  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-7xl mx-auto">
    <div>
      ...
      <div class="flex flex-wrap gap-4">
        <NuxtLink to="/" class="hero-btn hero-btn--primary !rounded-2xl shadow-lg shadow-emerald-500/20">
          <Library class="w-5 h-5" />
          Browse Problems
        </NuxtLink>
        <NuxtLink to="/assessment" class="hero-btn hero-btn--secondary !rounded-2xl">
          <Timer class="w-5 h-5" />
